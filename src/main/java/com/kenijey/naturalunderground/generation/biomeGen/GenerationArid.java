...
import com.kenijey.naturalunderground.generation.structureGen.GenerateSandstoneStalactites;
...
public final class GenerationArid extends WorldGenerator {
	...
	public boolean generate(World world, Random random, BlockPos pos) {
		switch (Utils.weightedChoise(WorldGenNaturalUnderGround.probabilitySandStalactites, WorldGenNaturalUnderGround.probabilitySpiderWeb, WorldGenNaturalUnderGround.probabilityDry, WorldGenNaturalUnderGround.probabilitySkulls,
				WorldGenNaturalUnderGround.probabilityStalactite, 0)) {
		case 1:
			new GenerateSandstoneStalactites().generate(world, random, pos, Utils.getNumEmptyBlocks(world, pos), WorldGenNaturalUnderGround.maxLength);
            return true;
		case 2:
